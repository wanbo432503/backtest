...
STRATEGY_DEFINITION = StrategyDefinition(
    ...
    parameters=(
        ...
        _param("stop_loss_pct", "初始止损", "float", 3, [2, 3, 5], 0.1, 30, 0.5),
        _param("profit_activation_pct", "移动保护激活盈利", "float", 5, [4, 5, 8], 0.1, 50, 0.5),
        _param("locked_profit_pct", "激活后锁定盈利", "float", 2, [1, 2, 3], 0, 30, 0.5),
        _param("trailing_stop_pct", "最高价回撤保护", "float", 2, [1.5, 2, 3], 0.1, 30, 0.5),
