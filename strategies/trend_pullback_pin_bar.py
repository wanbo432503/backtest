...
STRATEGY_DEFINITION = StrategyDefinition(
    ...
    parameters=(
        ...
        _param("max_body_range_pct", "实体占比上限", "float", 30.0, minimum=0.1, maximum=100, step=0.1),
        _param("min_close_location_pct", "收盘位置下限", "float", 65.0, minimum=0.1, maximum=100, step=0.1),
        _param("max_upper_shadow_range_pct", "上影占比上限", "float", 20.0, minimum=0.1, maximum=100, step=0.1),
